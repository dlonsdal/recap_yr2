...
Following the cyber incident, there is a slight change to how you can access <TT>RStudio</TT> and <TT>R</TT>. 

If you are *onsite*, you can use <https://shms-stats4.city.ac.uk/>. You will then need to login with your 'city.ac.uk' email address and password. 

If you are trying to access *offsite*, you cannot directly go to this web address. First you need to login to the virtual desktop. There are some instructions on how to do this [here](https://studenthub.citystgeorges.ac.uk/student-support-services/it-services/city-virtual-desktop#accordion858419-how-do-i-access-cvd?). 

A video with me showing you this (captioned) is below.

<video width="100%" controls>
  <source src="Accessing R_default.mp4" type="video/mp4">
  <track src="captions.vtt" kind="captions" srclang="en" label="English" default>
</video>


## Opening up a code file and starting the session

Click on the little plus icon at the top left of the screen and click 'R script'. This will open a new blank script for you to work in. I would advise you to then 'save' this script. Remember to save the file with a '.r' extension. For example. 'year2code.r'.

This will allow you to find it again in future. For those who like to organise their folders, you might choose to create a folder called 'year2' and put the r script in there. 


## Packages for this session

You _will_ need to run the following code in order to utilise the correct packages for this session.

```{r, echo=TRUE, eval=FALSE}

install.packages('tidyverse'); install.packages('DescTools')
...
## Practice: Basic Maths {.tabset .tabset-pills}
...
# Initial Analysis {.tabset .tabset-pills}
...
## Practice: AUC & Extended Tasks {.tabset .tabset-pills}

### Tasks {-}

Now let's look at IV and oral together to calculate the combined AUC. 
...
*Note: There are no solutions provided for the extended tasks, but feel free to post your suggestions on a discussion board.*

If you have questions about solving these tasks, ask tutors in the in-person session or email dlonsdal@sgul.ac.uk
